    ...
    public void buttonClicked(View v) {
        ...
        switch (v.getId()) {
            case (R.id.mood1):
                ...
                Toast.makeText(MainActivity.this, "Results for HAPPY!", Toast.LENGTH_LONG).show();
                break;
            case (R.id.mood2):
                toRestaurantResults.putExtra("term", searchTermForSadMood);
                Toast.makeText(MainActivity.this, "Results for SAD :(", Toast.LENGTH_LONG).show();
                break;
            case (R.id.mood3):
                toRestaurantResults.putExtra("term", searchTermForadventurousMood);
                Toast.makeText(MainActivity.this, "Results for ADVENTUROUS!", Toast.LENGTH_LONG).show();
                break;
            default:
                toRestaurantResults.putExtra("term", searchTermForhealthyMood);
                Toast.makeText(MainActivity.this, "Results for HEALTHY!", Toast.LENGTH_LONG).show();
                break;
        }
